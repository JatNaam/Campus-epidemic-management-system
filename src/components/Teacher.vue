<template>
  <el-container style="height: 800px; border: 1px solid #eee">
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      ...
      <div>
        <el-button type="primary" style="width: 180px; height: 50px ;margin: 5px" plain @click="showWitch(1);">查看上报历史
        </el-button>
        <el-button type="primary" style="width: 180px; height: 50px ;margin: 5px" plain @click="showWitch(2)">疫情上报
        </el-button>
        <el-button type="primary" style="width: 180px; height: 50px ;margin: 5px" plain @click="showWitch(3)">完善个人信息
        </el-button>
        <el-button type="primary" style="width: 180px; height: 50px ;margin: 5px" plain @click="showWitch(4)">班级疫情上报统计
        </el-button>
        <el-button type="primary" style="width: 180px; height: 50px ;margin: 5px" plain @click="showWitch(5)">班级疫情上报详情
        </el-button>
      </div>
    </el-aside>
    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-table v-show="this.showTableName === 1" :data="tableData" style="width: 100%">
          <el-table-column label="操作" width="120">
            <template slot-scope="scope">
              <el-button size="mini" width="120" @click="handleDelete(scope.$index, scope.row)">删除</el-button>
            </template>
          </el-table-column>
        ...
        <!--      显示上报内容-->
        <el-form :model="ruleForm" v-show="this.showTableName === 2" :rules="rules" ref="ruleForm" label-width="120px"
          style="width: 500px" class="demo-ruleForm">
          ...
          <el-form-item label="上报地点" prop="address2">
            <el-select v-model="ruleForm.address2" style="width: 200px">
              <el-option v-for="item in this.addresses" :value="item" :key="item">
                {{ item }}
              </el-option>
            </el-select>
          </el-form-item>
        ...
        <!--        完善个人信息-->
        <el-form :model="ruleForm" style="width: 300px;" v-show="this.showTableName === 3">
          <el-form-item label="出生日期">
            <el-date-picker v-model="userBase.birthday" :disabled="displayUserBase" style="width: 220px; " type="date"
              placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd">
            </el-date-picker>
          </el-form-item>
          <el-form-item label="真实姓名">
            <el-input v-model="userBase.name" :disabled="displayUserBase">
            </el-input>
          </el-form-item>

          <el-form-item label="邮箱">
            <el-input v-model="userBase.email" :disabled="displayUserBase">
            </el-input>
          </el-form-item>
          <el-form-item label="电话">
            <el-input v-model="userBase.phone" :disabled="displayUserBase">
            </el-input>
          </el-form-item>

          <el-form-item label="性别">
            <el-select v-model="userBase.sex" :disabled="displayUserBase">
              <el-option v-for="item in this.sexs" :value="item" :key="item">
                {{ item }}
              </el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="身份证号">
            <el-input v-model="userBase.idCardNumber" :disabled="displayUserBase">
            </el-input>
          </el-form-item>
        ...
        <div v-show="this.showTableName === 5">
          <el-form style="width:50% ">
            <el-form-item label="查询方式">
              <el-select v-model="todayStudentReportInfoShowType" style="width: 20%;margin-right: 20px">
                <el-option v-for="item in this.todayStudentReportInfoShowTypes" :value="item" :key="item">
                  {{ item }}
                </el-option>
              </el-select>
              <el-select v-model="selectClass" style="width: 20%;margin-right: 20px">
                <el-option v-for="item in this.selectClasses" :value="item.classId" :key="item.classId">
                  {{ item.classId }}
                </el-option>
              </el-select>
          ...
          <el-table :data="todayStudentReportInfo" style="width: 100%">
            <div>
            </div>
            <el-table-column label="操作" width="120">
              <template slot-scope="scope">
