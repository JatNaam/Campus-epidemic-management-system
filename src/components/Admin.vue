<template>
  <el-container style="height: 800px; border: 1px solid #eee">
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      ...
      <div>
        <el-button type="primary" style="width: 180px; height: 50px ;margin: 5px" plain @click="showWitch(1)">疫情上报统计
        </el-button>
        <el-button type="primary" style="width: 180px; height: 50px ;margin: 5px" plain @click="showWitch(2)">学生疫情上报详情
        </el-button>
        <el-button type="primary" style="width: 180px; height: 50px ;margin: 5px" plain @click="showWitch(3)">教师疫情上报详情
        </el-button>
        <el-button type="primary" style="width: 180px; height: 50px ;margin: 5px" plain @click="showWitch(4)">教师班级分配管理
        </el-button>
        <el-button type="primary" style="width: 180px; height: 50px ;margin: 5px" plain @click="showWitch(6)">系统日志
        </el-button>
      </div>
    </el-aside>
    <el-container>
      <el-header style="text-align: right; font-size: 25px; height: 60px;">
        <el-dropdown>
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <el-button type="text" @click="toLogin">注销</el-button>
            </el-dropdown-item>
                   </el-dropdown-menu>
        </el-dropdown>
      ...
      <el-main>
        ...
        <div v-show="this.showTableName === 1">
          ...
          <span style="display: flex;margin-bottom: 50px">
            ...
            <el-progress :stroke-width="18" type="circle" style="margin-right: 50px" v-if="parseInt(100 * (form3.todayStudentReportInfoYes.length + form2.todayStudentReportInfoYes.length
          ) / (form3.todayStudentReportInfoYes.length + form2.todayStudentReportInfoYes.length
            + form3.todayStudentReportInfoNo.length + form2.todayStudentReportInfoNo.length))" :percentage="parseInt(100 * (form3.todayStudentReportInfoYes.length + form2.todayStudentReportInfoYes.length
) / (form3.todayStudentReportInfoYes.length + form2.todayStudentReportInfoYes.length
  + form3.todayStudentReportInfoNo.length + form2.todayStudentReportInfoNo.length))">
            ...
            <el-progress :stroke-width="18" type="circle" v-if="parseInt(100 - 100 * (form3.todayStudentReportInfoYes.length + form2.todayStudentReportInfoYes.length
          ) / (form3.todayStudentReportInfoYes.length + form2.todayStudentReportInfoYes.length
            + form3.todayStudentReportInfoNo.length + form2.todayStudentReportInfoNo.length))" :percentage="parseInt(100 - 100 * (form3.todayStudentReportInfoYes.length + form2.todayStudentReportInfoYes.length
) / (form3.todayStudentReportInfoYes.length + form2.todayStudentReportInfoYes.length
  + form3.todayStudentReportInfoNo.length + form2.todayStudentReportInfoNo.length))" color="red">
            </el-progress>
          </span>
          <span style="display: flex;margin-bottom: 50px">
            教师已上报人数：{{ form3.todayStudentReportInfoYes.length }}人
            <el-progress :stroke-width="18" type="circle" style="margin-right: 50px" v-if="parseInt(100 * form3.todayStudentReportInfoYes.length /
          (form3.todayStudentReportInfoYes.length +
            form3.todayStudentReportInfoNo.length))" :percentage="parseInt(100 * form3.todayStudentReportInfoYes.length /
  (form3.todayStudentReportInfoYes.length +
    form3.todayStudentReportInfoNo.length))">
            </el-progress>
            教师未上报人数：{{ form3.todayStudentReportInfoNo.length }}人
            <el-progress :stroke-width="18" type="circle" :percentage="parseInt(100 * form3.todayStudentReportInfoNo.length /
          (form3.todayStudentReportInfoYes.length +
            form3.todayStudentReportInfoNo.length))" v-if="parseInt(100 * form3.todayStudentReportInfoNo.length /
  (form3.todayStudentReportInfoYes.length +
    form3.todayStudentReportInfoNo.length))" color="red">
            </el-progress>
          </span>
          <span style="display: flex;margin-bottom: 50px" v-for="item in form2.selectClasses"
            v-show="item.classId != '全部'">
            {{ item.classId }}班级已上报人数：{{ item.yesNumber }}人
            <el-progress :stroke-width="18" type="circle" style="margin-right: 50px"
            ...
            <el-progress :stroke-width="18" type="circle" color="red"
        ...
        <div v-show="this.showTableName === 2">
          <el-form style="width:50% ">
            <el-form-item label="查询条件">
              ...
              <el-select v-model="form2.selectClass" style="width: 20%;margin-right: 20px">
                <el-option v-for="item in this.form2.selectClasses" :value="item.classId" :key="item.classId">
                  {{ item.classId }}
                </el-option>
              </el-select>
          ...
          <el-table :data="form2.todayStudentReportInfo" style="width: 100%">
            <div>
            </div>
            <el-table-column label="操作" width="120">
              <template slot-scope="scope">
                <el-button size="mini" width="120">提醒</el-button>
        ...
        <div v-show="this.showTableName === 3">
          ...
          <el-table :data="form3.todayStudentReportInfo" style="width: 100%">
            <div>
            </div>
            <el-table-column label="操作" width="120">
              <template slot-scope="scope">
        ...
        <div v-show="this.showTableName === 4">
          <el-table :data="form4.teacherClassesInfo" style="width: 100%">
            <div>
            </div>
            <el-table-column label="操作" width="120">
              <template slot-scope="scope">
                <el-button @click="deleteTeacherClass(scope.$index, scope.row)" size="mini" width="120">
                  删除
                </el-button>
              </template>
            </el-table-column>
            <el-table-column label="操作" width="120">
              <template slot-scope="scope">
                <el-button @click="toSetTeacherClass(scope.$index, scope.row)" size="mini" width="120">新建</el-button>
              </template>
            </el-table-column>
        ...
        <div v-show="this.showTableName === 5" style="width: 40%">
          <el-form>
            <el-form-item label="教师工号:">
              <el-input v-model="form4.teacherId" style="width: 30%" :disabled="true">
              </el-input>
            </el-form-item>
            <el-form-item label="班级：">
              ...
              <el-select v-model="form4.setClassId" style="width: 40%;margin-right: 20px">
                <el-option v-for="item in this.form2.selectClasses"
                  v-show="item.classId !== '全部' && item.classId !== form4.classId" :value="item.classId"
                  :key="item.classId">
                </el-option>
              </el-select>
            </el-form-item>
        ...
        <div v-show="this.showTableName === 6">
          <el-form :model="form6.form" style="width: 600px;">
            <el-form-item label="选择日期">
              <el-date-picker v-model="form6.form.date" style="width: 220px; margin-right: 100px" type="date"
                placeholder="选择日期" format="yyyy 年 MM 月 dd 日" :picker-options="timeChange" value-format="yyyy-MM-dd">
              </el-date-picker>
              <el-button type="bblue" @click="getSystemLog()">点击查询日志</el-button>
            </el-form-item>
          </el-form>
          <el-table :data="form6.systemLog" style="width: 100%">
